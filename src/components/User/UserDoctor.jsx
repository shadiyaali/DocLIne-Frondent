...
function UserDoctor() {
  ...
  return (
    ...
    <span className="border-b-  pb-2 mt-15 mr-4"></span>  DOCTORS
  </h1>
    <div className="flex flex-wrap gap-20 justify-center  ">
      
    {
      doctors?.map(doctor => (
          <Card className="w-80 flex flex-col shadow-xl">
      ...
      <Link to="userappointment">
        <button className=" py-3 bg-green w-full text-white">Book Now</button>
      </Link>
      </CardFooter>
    </Card>
      ))
